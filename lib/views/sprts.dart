...
import 'package:flutter_application_1/views/sciences.dart';
...
class Sports extends GetWidget {
  ...
  final String title = '  أخبار الرياضة ';
  @override
                    ...
                    return Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          Text(todos[index]['description'].toString(),style: TextStyle(color:controller.secColor,)),
                        ]),
                      ),
                    );
                  });
